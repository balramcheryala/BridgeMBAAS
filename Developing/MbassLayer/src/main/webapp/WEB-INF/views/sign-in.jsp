	...
	<div class="main-wrapper">
		<div class="app" id="app">
			...
			<div class="sidebar-container">
				...
				<ul class="nav metismenu" id="sidebar-menu">
					<li><a href=""> <i class="fa fa-home"></i> 
							<b style:"color=white">${projectname}</b>
					</a></li>
					<li class="active open"><a href=""><i class="fa fa-user"
							aria-hidden="true"></i><b style:"color=white">Auth</b> <i class="fa arrow"></i>
					</a>
						<ul>
							<li class="active"><a href="userpage"><b style:"color=white">Users</b></a></li>
							<li><a href="signinby"><b style:"color=white">Sign-in Method</b></a></li>
						</ul></li>
						<li><a href="database"><i class="fa fa-database"
							aria-hidden="true"></i>
							<b style:"color=white">DataBase</b>
					</a></li>
						<li><a href="testdemo"> <i class="fa fa-twitter"></i>
							<b style:"color=white">BufferPost</b>
					</a></li>
			</aside>
			...
			<div class="title-block">
				...
				<h5 class="title">
				<b style="color:blue">${success}</b><span class="sparkline bar" data-type="bar"></span>
				</h5>
			</div>
			<form name="item">
