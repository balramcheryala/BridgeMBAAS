			...
			<div class="sidebar-container">
				...
				<ul class="nav metismenu" id="sidebar-menu">
					...
					<li class="active open"><a href=""> <i class="fa fa-user"
						...
						<ul>
							<li class="active"><a href="userpage"><b
									style:"color=white">Users</b></a></li>
							<li><a href="signinby"><b
									style:"color=white">Sign-in Method</b></a></li>
						</ul></li>
					<li><a href="database"><i class="fa fa-database"
							aria-hidden="true"></i> <b style:"color=white">Database</b> </a></li>
					<li><a href="testdemo"> <i class="fa fa-twitter"></i> <b
							style:"color=white">Buffer Post</b>
					</a></li>
			</aside>
