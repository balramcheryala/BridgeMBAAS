				...
				<div class="sidebar-container">
					...
					<ul class="nav metismenu" id="sidebar-menu">
						...
						<li class="active open"><a href=""> <i
								class="fa fa-th-large"></i><b style:"color=white">Auth</b> <i class="fa arrow"></i>
						</a>
							<ul>
						...
						<li><a href="database"> <i class="fa fa-home"></i>
							<b style:"color=white">DataBase</b>
						</a></li>
						<li><a href="testdemo"> <i class="fa fa-database"
							aria-hidden="true"></i> 
								<b style:"color=white">Buffer Post</b>
						</a>
				</aside>
