...
public class AuthController {
	...
	public ModelAndView signInBy() {
		...
		model.addObject("projectname",Dashboard.globalname);
	...
	public ModelAndView UserInfo() {
		...
		model.put("students", preparation.prepareListofBean(detailservice.listClientDetails(Dashboard.globalname)));
		model.put("title", "BRIDGEMBASS");
	...
	public ModelAndView ClientCredentialsave(@ModelAttribute("command") ClientCredentialsBean credentialbean,
		...
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("title", "BRIDGEMBASS");
		model.put("success", "Your Credentials Saved Successfully Into the database ");
		model.put("projectname", Dashboard.globalname);
	 ...
	 * Editdata.
	 *
	 * @param clientdetailsbean the clientdetailsbean
	...
	public ModelAndView editdata(@ModelAttribute("command") ClientDetailsBean clientdetailsbean, BindingResult result) {
		...
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("student", preparation.prepareCrudBean(detailservice.getClientDetails(clientdetailsbean.getId(),Dashboard.globalname)));
		model.put("crud", preparation.prepareListofBean(detailservice.listClientDetails(Dashboard.globalname)));
		model.put("title", "BRIDGEMBASS");
		model.put("projectname",Dashboard.globalname);
